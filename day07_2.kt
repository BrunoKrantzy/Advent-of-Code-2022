...
fun main() {
    ...
    val fileSize = 70000000L
    val unusedSize = 30000000L

    var dif = fileSize - sizeAllDir
    var need = unusedSize - dif
    var bestDir = Long.MAX_VALUE
    ...
    dirList.forEach {
        var szD = it.tailleDir
        if (szD >= need) {
            bestDir = (minOf(bestDir, szD))
        }
    }
